...
- public/list.php :
	...
	* r�cup�rer toutes les informations sur tous les
  �tudiants en DB
	* inclure la vue correspondant � la page "list"
	* afficher les informations
  (id, nom, pr�nom, email et date de naissance)
  sous forme de tableau (<table>).
...
- public/list.php :
	* pour chaque ligne du tableau (<table>),
  ajouer un bouton (lien) qui envoie sur la page student
